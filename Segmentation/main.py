...
#Define loss and metrics lists for plotting
train_losses=[]
val_losses=[]
train_iou=[]
val_iou=[]
...
for epoch in range(epochs):
    ...
    for i, data in enumerate(train_loader):
        ...
        # Compute average values and append them to lists for plotting
    ...
    # If this epoch results in the best validation loss, save the model
